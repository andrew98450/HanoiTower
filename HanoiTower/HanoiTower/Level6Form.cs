...
{
    public partial class Level6Form : Form
    {
        const int limit_count = 270;
        const int tower_count = 8;
        int count = 1;
        bool is_push = false;
        string[] tower = { "=", "===", "=====", "=======", "=========",
            "===========", "=============" ,"==============="};
        ...
        private void Level6Form_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        private void Level6Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            MainForm form = new MainForm();
            form.Show();
            Hide();
